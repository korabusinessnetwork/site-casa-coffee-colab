...
function initCatalogPage() {
  ...
  const aplicar = () => {
    ...
    // Reordena MOVENDO os nós, nunca re-renderizando: os corações de "ficou pra
    // depois" e o "me avisa quando voltar" são injetados nos cards depois do
    // primeiro render, e sobreviveriam a um innerHTML novo.

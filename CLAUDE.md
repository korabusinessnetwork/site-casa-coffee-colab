...
- **Busca + ordenação (`/loja`)**: além do filtro por categoria, a vitrine tem um campo de
  ...
  re-renderiza: os corações de "ficou pra depois" e o "me avisa quando voltar" são injetados
  nos cards depois do primeiro render e não sobreviveriam a um `innerHTML` novo. Um
